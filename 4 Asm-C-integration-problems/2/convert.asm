...
nr_baza_8_cifre dd -1 							; numarul de cifre din numarul in baza 8
...
_convert: 
		...
		push EBP
		mov EBP, ESP						; creez un cadru de stiva pentru modul
		
		mov ESI, [ebp + 8]					; punem in ESI adresa string-ului ( care reprezinta numarul in baza 2 ) 				
		...
		.repeta3:
			...
			mul EDX							; inmultim numarul in baza 8 cu 10 ( pentru a muta cifrele in stanga cu o unitate)
											; practic numarul se comporta ca un numar in baza 10, dar are forma unui numar in baza 8
		LOOP .repeta3							
		...
		div BX
											; avem in EAX numarul		
		pop ebp								; inchid cadrul de stiva pentru modul
